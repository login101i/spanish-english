...
const questions = [
    ...
    "529Recién (hecho /escrito / nacido…)",
    "530 Una afición",
...
const answers = [
    ...
    "532 Una pasión - Un sentimiento muy intenso por una cosa upersona.En nuestro caso hablamos de que hay muchaspersonas en Barcelona que comparten la misma pasión por patinar.Un sinónimo aquí podría ser hobby, afición, hacer algo que nos encanta, algo que nos gusta mucho… Cuando una persona siente pasión por algo, en nuestro caso por patinar, normalmente intenta emplear cada rato libre que tiene para hacerlo.Porque le encanta, porque le gusta mucho",
    ...
    "538 El agobio - Una sensación de ansiedad o inquietud intensaprovocada por una situación difícil y que cuesta mucho desuperar.Normalmente viene acompañada por estado demolestia y cansancio.Por ejemplo: “El periodo de cierre de año, siempre es una temporada de mucho agobio en el trabajo”.El verbo es “agobiar”.Por ejemplo: “No me agobies con tus preguntas”. “Carmen se agobia por todo”.",
    ...
    "540 “Cantidad” - está usado aquí de forma coloquial, ysignifica “mucho”.Por ejemplo: “Me gusta cantidad”. “Ha nevado cantidad”. “Veo cantidad de películas”.",

    "541Ir a dormir a las tantas - es la forma coloquial o abreviada de a las tantas de la mañana o de la madrugada .Por tanto, “Ir a dormir a las tantas” significa “ir a dormir muy tarde”.Por ejemplo: “El año pasado tuve una conversación con Ana hasta las tantas de la noche",
    ...
    "543 Divertirse, generalmente de noche, salir a tomar copas y quizá también bailar.La expresión seempezó a usar en los años 80 y se sigue usando en laactualidad. Pero, ir al cine o a un concierto no es salir de marcha.Ir sólo a cenar y volverte a casa tras el postre, tampoco. Salir de marcha implica ir a bares o discotecas, es decir, sitios donde consume alcohol y donde suena música a todo volumen.",
...
const generateQuestion = () => {
    ...
    const match = question.substr(0, 5)
    const match2 = question.substr(0, 5)
    const answer = answers.filter(ans => ans.substr(0, 5) === match)
